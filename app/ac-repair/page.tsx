...
export default function AcRepairPage() {
  ...
  return <><SiteHeader /><main className="overflow-hidden bg-white text-slate-900">
    ...
    <section className="bg-[#062c55]"><div className="mx-auto max-w-7xl px-5 py-12 text-white sm:px-8"><h2 className="max-w-lg text-3xl font-black">AC Not Cooling? Call Top Notch Today.</h2><p className="mt-3 text-sky-100">Professional AC repair and diagnostics throughout South Florida.</p><div className="mt-7 flex flex-col gap-3 sm:flex-row"><ActionButton phone className="bg-red-600 hover:bg-red-700">Call {content.phone}</ActionButton><ActionButton>Book Service</ActionButton></div></div></section>
  </main><SiteFooter /></>;
}
