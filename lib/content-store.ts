...
export const defaultContent: EditableContent = {
  ...
  acHub: {
    ...
    heroDescription: "Professional AC repair, installation and maintenance for homes, condos and businesses throughout South Florida.",
    ...
    serviceCards: [
      ...
      { title: "Emergency AC Repair", description: "Fast service for urgent cooling problems and unexpected AC breakdowns when your system stops working properly.", href: "/emergency-ac-repair", image: "/images/ac/emergency-ac-repair.jpg", active: false },
      ...
      { title: "AC Replacement", description: "Replacement options for aging, inefficient or failed equipment with properly selected matched systems.", href: "/ac-replacement", image: "/images/ac/ac-replacement.jpg", active: false },
      ...
      { title: "AC System Diagnostics", description: "Complete diagnostics for electrical, airflow, refrigerant, thermostat and mechanical cooling concerns.", href: "/ac-diagnostics", image: "/images/ac/ac-diagnostics.jpg", active: false },
      { title: "Air Handler Service", description: "Inspection, repair, cleaning and replacement for blower, drainage, coil, electrical and airflow problems.", href: "/air-handler-service", image: "/images/ac/air-handler-service.jpg", active: false },
      { title: "Ductless Mini-Split Services", description: "Installation, maintenance and repair for ductless mini-split air conditioning systems.", href: "/ductless-mini-split", image: "/images/ac/ductless-mini-split.jpg", active: false },
      { title: "Thermostat Services", description: "Thermostat installation, replacement and troubleshooting for compatible HVAC systems.", href: "/thermostat-services", image: "/images/ac/thermostat-services.jpg", active: false },
    ],
    ...
    installation: ["Central AC Installation", "Air Handler Installation", "Condenser Installation", "Heat Pump Systems", "Duct/Return Evaluation"],
    faqs: [
