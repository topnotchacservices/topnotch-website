...
export const defaultContent: EditableContent = {
  ...
  acHub: {
    ...
    serviceCards: [
      ...
      { title: "Emergency AC Repair", description: "Fast service for urgent cooling problems and unexpected AC breakdowns when your system stops working properly.", href: "/emergency-ac-repair", image: "/images/home/ac-system-service.svg", active: true },
      ...
      { title: "AC Replacement", description: "Replacement options for aging, inefficient or failed equipment with properly selected matched systems.", href: "/ac-replacement", image: "/images/home/ac-installation.svg", active: true },
      ...
      { title: "AC System Diagnostics", description: "Complete diagnostics for electrical, airflow, refrigerant, thermostat and mechanical cooling concerns.", href: "/ac-diagnostics", image: "/images/home/ac-repair.svg", active: true },
      { title: "Air Handler Service", description: "Inspection, repair, cleaning and replacement for blower, drainage, coil, electrical and airflow problems.", href: "/air-handler-service", image: "/images/home/ac-system-service.svg", active: true },
      { title: "Ductless Mini-Split Services", description: "Installation, maintenance and repair for ductless mini-split air conditioning systems.", href: "/ductless-mini-split", image: "/images/home/ac-installation.svg", active: true },
      { title: "Thermostat Services", description: "Thermostat installation, replacement and troubleshooting for compatible HVAC systems.", href: "/thermostat-services", image: "/images/home/ac-maintenance.svg", active: true },
    ],
