...
export const defaultContent: EditableContent = {
  ...
  acHub: {
    ...
    serviceCards: [
      { title: "AC Repair", description: "Professional diagnosis and repair for systems that are not cooling, failing to start, leaking, cycling improperly or experiencing electrical, refrigerant or airflow problems.", href: "/ac-repair", image: "/images/home/ac-repair.svg", active: true },
      { title: "Emergency AC Repair", description: "Fast service for urgent cooling problems and unexpected AC breakdowns when your system stops working properly.", href: "/emergency-ac-repair", image: "/images/home/ac-system-service.svg", active: false },
      { title: "AC Installation", description: "Professional installation of new central air conditioning systems with careful setup, connections and startup testing.", href: "/ac-installation", image: "/images/home/ac-installation.svg", active: true },
      { title: "AC Replacement", description: "Replacement options for aging, inefficient or failed equipment with properly selected matched systems.", href: "/ac-replacement", image: "/images/home/ac-installation.svg", active: false },
      { title: "AC Maintenance & Tune-Ups", description: "Preventive maintenance for system operation, airflow, electrical components, drainage and cooling performance.", href: "/ac-maintenance", image: "/images/home/ac-maintenance.svg", active: true },
      { title: "AC System Diagnostics", description: "Complete diagnostics for electrical, airflow, refrigerant, thermostat and mechanical cooling concerns.", href: "/ac-diagnostics", image: "/images/home/ac-repair.svg", active: false },
      { title: "Air Handler Service", description: "Inspection, repair, cleaning and replacement for blower, drainage, coil, electrical and airflow problems.", href: "/air-handler-service", image: "/images/home/ac-system-service.svg", active: false },
      { title: "Ductless Mini-Split Services", description: "Installation, maintenance and repair for ductless mini-split air conditioning systems.", href: "/ductless-mini-split", image: "/images/home/ac-installation.svg", active: false },
      { title: "Thermostat Services", description: "Thermostat installation, replacement and troubleshooting for compatible HVAC systems.", href: "/thermostat-services", image: "/images/home/ac-maintenance.svg", active: false },
    ],
  ...
  acRepair: {
    ...
    heroImage: "/images/ac/emergency-ac-repair.jpg",
